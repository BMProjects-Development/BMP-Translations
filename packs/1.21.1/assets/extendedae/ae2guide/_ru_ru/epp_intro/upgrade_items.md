...
Эти улучшения позволяют заменить обычные ME устройства их расширенной версией без их повреждения.
...
Нажмите Shift + Правая кнопка мыши на эти устройства, и они превратятся в свою расширенную версию. Все настройки устройства и инвентарь будут сохранены.

<GameScene zoom="6" background="transparent">
  <ImportStructure src="../structure/upgrade_show_1.snbt"></ImportStructure>
  <BoxAnnotation color="#ffffff" min="1 0 0" max="4 1 1">
        Обычные Хранители Шаблонов. Вы можете улучшить их с помощью Улучшения Хранителя Шаблонов.
...
<GameScene zoom="6" background="transparent">
  ...
  <BoxAnnotation color="#ffffff" min="1 0 0" max="4 1 1">
        Расширенные Хранители Шаблонов сохраняют все настройки и инвентарь шаблонов от исходных Хранителей Шаблонов
  </BoxAnnotation>
</GameScene>
